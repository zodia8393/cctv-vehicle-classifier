...
출력:
  /workspace/prj/AI기반 교통상황 대응 기술 개발 연구/output/labeling/
...
OUTPUT_DIR = Path("/workspace/prj/AI기반 교통상황 대응 기술 개발 연구/output/labeling")
HOLDOUT_DIR = Path("/workspace/prj/AI기반 교통상황 대응 기술 개발 연구/pipeline/data/holdout_gt_v3")
