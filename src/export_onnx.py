...
생성 위치: /workspace/prj/AI기반 교통상황 대응 기술 개발 연구/output/_models_preserved/onnx/
...
ONNX_DIR = Path("/workspace/prj/AI기반 교통상황 대응 기술 개발 연구/output/_models_preserved/onnx")
ONNX_DIR.mkdir(parents=True, exist_ok=True)

MODEL_DIR = Path("/workspace/prj/AI기반 교통상황 대응 기술 개발 연구/pipeline/data/models")
PRESERVED = Path("/workspace/prj/AI기반 교통상황 대응 기술 개발 연구/output/_models_preserved")
